...
public class UtilClass {
    ...
    public static void waitForWebPageLoad(String UrlContains){
        Hook.driver.manage().timeouts().pageLoadTimeout(3, TimeUnit.SECONDS);
    ...
    public static void assertPageUrlContains (String partUrl){
        assertTrue(Hook.driver.getCurrentUrl().contains(partUrl));
    }

    public static void clickWebElement (By identifier){
        waitForElement(identifier);
        Hook.driver.findElement(identifier).click();
    }
    ...
    public static void tabAwayFromWebElement (By identifier) {
        WebElement element = Hook.driver.findElement(identifier);
    ...
    public static void selectSelect (By identifier, String option){
        Select sel = new Select((WebElement) Hook.driver);
    ...
    public static void assertWebElementIsDisplayed (By identifier){
        waitForElement(identifier);
        assertTrue(Hook.driver.findElement(identifier).isDisplayed());
    }
    ...
    public static void assertWebElementIsNotDisplayed (By identifier){
        waitForElement(identifier);
        assertFalse(Hook.driver.findElement(identifier).isDisplayed());
    }
...
//    }
    ...
    public static void assertWebElementIsEnabled (By identifier){
        waitForElement(identifier);
        assertTrue(Hook.driver.findElement(identifier).isEnabled());
    }

    public static void assertWebElementIsSelectedd (By identifier){
        waitForElement(identifier);
        assertTrue(Hook.driver.findElement(identifier).isSelected());
    }

    public static void assertWebElementIsNotSelected (By identifier){
        waitForElement(identifier);
        assertFalse(Hook.driver.findElement(identifier).isSelected());
    }
    ...
    public static void assertWebElementText(By identifier, String webElementText) {
        assertEquals((webElementText), Hook.driver.findElement(identifier).getText());
    }
    ...
    public static void assertSelectOption(By identifier, String option) {
        Select sel = new Select(Hook.driver.findElement(identifier));
        assertEquals((option), Hook.driver.findElement(identifier).getText());
    }

    public static void assertWebElementAttribute(By identifier, String attribute, String attributeContent) {
        assertEquals(attributeContent, Hook.driver.findElement(identifier).getAttribute(attribute));
    }


    public static void assertFieldPopulatedCharacterLength (By identifier, int inputCharacterLength){
        assertEquals(inputCharacterLength, Hook.driver.findElement(identifier).getAttribute("value").length());
    }

    public static void assertBorderColor (By identifier, String borderColor) {
        assertEquals(borderColor, Hook.driver.findElement(identifier).getCssValue("CssValueName"));
    }

    public static void assertTheDropDownContains(By identifier){
        Select select = new Select(Hook.driver.findElement(identifier));
    ...
    public static String getTextFromTextBox (By identifier) {
        return Hook.driver.findElement(identifier).getAttribute("value");
    }
    ...
    public static void assertDynamicTextData(String text, By identifier) {
        ...
        String elementText = Hook.driver.findElement(identifier).getText();
    ...
    public static void elementSelection(By elementSelector) {
        ...
        List<WebElement> myElements = Hook.driver.findElements(elementSelector);
